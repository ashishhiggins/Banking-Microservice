...
import com.eazybytes.cards.dto.CardsContactsInfoDto;
...
public class CardsController {
    ...
    @Operation(
            summary = "Get Contacts Info REST API",
            description = "REST API to get the contact information of the Cards microservice"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
    ...
    public ResponseEntity<CardsContactsInfoDto> getContactsInfo() {
        return ResponseEntity.status(HttpStatus.OK).body(cardsContactsInfoDto);
    }
